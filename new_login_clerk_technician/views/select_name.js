  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      if (res != "") {
        ...
        $('#address').text(res[2])
        $('#e_mail').text(res[3])
        $("#report_icon").html('<img src="info.png" id="report_icon" style="position: absolute;top:50%;float: left;margin-left: 24px;width:20px;height:20px;border-radius:20%;"> </img>')
